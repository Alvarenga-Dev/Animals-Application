package com.alvarengadev.animalsapplication
...
import com.alvarengadev.animalsapplication.api.AnimalService
import com.alvarengadev.animalsapplication.model.Animal
import com.alvarengadev.animalsapplication.ui.theme.AnimalsApplicationTheme
import com.alvarengadev.animalsapplication.view.MainIntent
import com.alvarengadev.animalsapplication.view.MainState
import com.alvarengadev.animalsapplication.view.MainViewModel
import com.alvarengadev.animalsapplication.view.ViewModelFactory
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            AnimalsApplicationTheme {
                // A surface container using the 'background' color from the theme
                Surface(
                    modifier = Modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background
                ) {
                    MainScreen(
                        viewModel = viewModel, onButtonClick = onButtonClick
                    )
                }
            }
        }
...
fun MainScreen(viewModel: MainViewModel, onButtonClick: () -> Unit) {
    when (val state = viewModel.state.value) {
        ...
        is MainState.Success -> AnimalListScreen(animals = state.animals)
        is MainState.Error -> {
